...
*/
package it.nextworks.nfvmano.nfvodriver.nfvopoller;
...
@EnableScheduling
@Service
public class NfvoOperationPollingManager implements SchedulingConfigurer {

	private static final Logger log = LoggerFactory.getLogger(NfvoOperationPollingManager.class);
	
	@Value("${sebastian.nfvo.timeo.polling}")
	private int pollingPeriod;
	
	//map of active polled operations on NFVO. The key is the operation ID. The value provides the info to poll the operation.
	private Map<String, PolledNfvoOperation> polledOperations = new HashMap<>();
	...
	public NfvoOperationPollingManager() {
	...
	public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
		...
		taskRegistrar.addTriggerTask(
				new NfvoOperationPollingTask(this, nfvoService, nfvoNotificationManager),
				new Trigger() {
	...
	/**
	 * Adds a new NFVO operation in the list of the operations to be polled
	 * 
	...
	public synchronized void addOperation(String operationId, OperationStatus expectedStatus, String nfvNsiId, String operationType) {
		PolledNfvoOperation operation = new PolledNfvoOperation(operationId, expectedStatus, nfvNsiId, operationType);
...
//	 */
//	public Map<String, PolledNfvoOperation> getPolledOperations() {
...
//	}
	 ...
	 */
	public synchronized Map<String, PolledNfvoOperation> getPolledOperationsCopy() {
		Map<String, PolledNfvoOperation> copy = new HashMap<>();
		for (Map.Entry<String, PolledNfvoOperation> e : polledOperations.entrySet()) {
